...
class EntryFormBuilder extends MultipleFormBuilder
{
    ...
    protected $buttons = [
        ...
        'change' => [
            'data-toggle' => 'modal',
            'data-target' => '#modal',
            'href'        => 'admin/menus/links/{request.route.parameters.menu}/change/{request.route.parameters.id}',
        ],
        'view'   => [
            'enabled' => 'edit',
            'target'  => '_blank',
            'href'    => 'admin/menus/links/{request.route.parameters.menu}/view/{request.route.parameters.id}',
        ],
    ];
    ...
    public function onReady()
    {
        if ($this->getFormMode() == 'create') {
            $this->setOption('redirect', 'admin/menus/links/{request.route.parameters.menu}');
        }
    }
